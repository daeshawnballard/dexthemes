...
- [`storyboard.json`](./storyboard.json) is the machine-readable `1:38` timeline.
...
The V5 cut reaches the product value immediately, completes the create → preview → apply happy path by `0:29`, and treats achievements as one collective progression system rather than a featured reward.
