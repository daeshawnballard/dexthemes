...
export const UNLOCK_THEMES = {
  ...
  use_deepseek_harness: { themeId: 'deep-current', name: 'Deep Current', achievement: 'Harnessed', description: 'Abyssal cobalt and clear cyan for creators shaping their workspace through DeepSeek Harness.', prompt: 'Complete DexThemes Connect in DeepSeek Harness to unlock', deeplink: 'deepseek-harness', availability: 'device_oauth_required' },
