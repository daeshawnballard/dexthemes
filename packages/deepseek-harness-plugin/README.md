...
Install the published `0.6.2` package from npm:
...
The current npm release is `0.6.2`. See the [changelog](CHANGELOG.md) and the [0.6.2 release](https://github.com/daeshawnballard/dexthemes/releases/tag/deepseek-harness-plugin-v0.6.2).
