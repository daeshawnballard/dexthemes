...
export const RATE_LIMITS = {
  ...
  connectedAppsReadIdentity: { maxRequests: 30, windowMs: 60 * 1000 },
  connectedAppsReadNetwork: { maxRequests: 120, windowMs: 60 * 1000 },
  connectedAppsWriteIdentity: { maxRequests: 10, windowMs: 60 * 60 * 1000 },
  connectedAppsWriteNetwork: { maxRequests: 60, windowMs: 60 * 60 * 1000 },
